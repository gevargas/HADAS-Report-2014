...
\item[Contracts:] 
OPTIMACS (2009-2012)	Agence Nationale de la Recherche, France, Programme ARPEGE LIG, LAMIH, LIRIS Service composition based framework for optimizing queries. Coordinator
...
AIWS (2012 - 2014)	PEPS  CNRS program (LIRIS-LIG) Discovering conversations among services by analyzing event logs - Coordinator

CAISES (2012 - 2015)	European Union FP7, IRESES program (UK, France, Ukrania, China) Observation and industrial management on the cloud.  Participant
...
Nous avons des collaborations avec l'Universite� Federal Rio Grande do Norte, d partement DIMAP,  equipe FORALL depuis 2007. Les collaborations portent sur la gestion de donn ees   base de services sur le cloud: int egration s mantique de services de donne es   travers les mashups, coordination de services   base de politiques,  traitement de donn es sur cloud avec des approches Map-Reduce, des langages d'interrogation de donne es   base de composition de services.  
Nous avons privil gi e des applications sur les donn es me t eorologiques et la distribution  nerg tique. Cette recherche s'est r ealis e   travers des projets soutenus par Microsoft (e-CLOUDSS), par le programme STICAMSUD (CLEVER et SWANS) et   travers le co-encadrement d'e tudiants de master et de th se. 
La CAPES a  egalement finance  des postdocs et le CNRS des postes de prof invite .
...
\item {\it Vice-presidence  comit{\'e} d'{\'e}valuation scientifique  Big Data, d ecision, simulation, HPC}   Ch. Collet (2014-)

\item {\it ANR, Comite  de pilotage Mod les num{\'e}riques}, Ch. Collet, 2010-2013
...
\item[Devenir:]  Le devenir des doctorants est varie  : X dans l'industrie (Chercheur ou ingenieur R $\&$ D) ;  2 dans le superieur. 
The becoming of the students is varied: X are in industry (researcher or engineer R  $\&$ D),  have academic positions
