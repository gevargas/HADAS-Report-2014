...
The team currently includes 9 research persons (2 full professors, 5 Associate Professor and two CNRS Research Scientist) and a research engineer and 15 PHD students and post-docs. Durant this period we hired 3 people. 
...
U. de la Repuública, Uruguay, UFRN Brazil, LIG, LAFMIA, LIFO, France
...
Inserer Ici tableau réecapitulatif des publications 

\ \\

discussion de l'{\'e}volution des publications en terme de quantit{\'e}é et qualit{\'e}é entre le précédent quadriennal et 2009-2014. 
...
\item Best Paper Award track Embedded Software à DATE 2014.
...
\begin{description}
\item[Mexico:] the group has a long tradition in developing cooperations between the Mexican and French governments in TICS for 20 years. Since 2008, G. Vargas-Solar is deputy director of the French Mexican Laboratory in Informatics and Automatic Control (LAFMIA, UMI 371) an international unit of the CNRS. 
...
Nous avons des collaborations avec l'Universiteé Federal Rio Grande do Norte, département DIMAP, éequipe FORALL depuis 2007. Les collaborations portent sur la gestion de donnéees à base de services sur le cloud: intéegration sémantique de services de donneées à travers les mashups, coordination de services à base de politiques,  traitement de données sur cloud avec des approches Map-Reduce, des langages d'interrogation de donneées à base de composition de services.  
Nous avons privilégiée des applications sur les données meétéeorologiques et la distribution énergétique. Cette recherche s'est réealisée à travers des projets soutenus par Microsoft (e-CLOUDSS), par le programme STICAMSUD (CLEVER et SWANS) et à travers le co-encadrement d'eétudiants de master et de thèse. 
La CAPES a éegalement financeé des postdocs et le CNRS des postes de prof inviteé.
...
\item {\it Bases de Donn{\'e}es Avanc{\'e}es (BDA)}, Ch. Collet (2010, 2012, 2013), Ch. Bobineau (2009), G. Vargas-Solar(2011) 

\item {\it Gestion des Donn{\'e}es dans les Syst{\`e}mes d'Information Pervasifs (GEDSIP)}, Ch. Bobineau (2009), G. Vargas-Solar (2009)
...
\item {\it Vice-presidence  comit{\'e} d'{\'e}valuation scientifique  Big Data, déecision, simulation, HPC   Ch. Collet (2014-)

\item {\it ANR, Comiteé de pilotage Modèles num{\'e}riques}, Ch. Collet, 2010-2013
...
\item[DATARING] (ANR, Programme R{{\'e}}seaux du futur et services 2008-2011), 3 partners (http://www.lina.univ-nantes.fr/projets/DataRing/). 130 549 \texteuro. Coordinator: INRIA Nantes, Scientific lead in LIG: M.-C. Rousset. 
...
\item[CONTINUUM] (ANR, Programme R{\'e}seaux du futur et services 2008-2011),  7 partners (I3S, LIG, SUEZ ENVIRONNEMENT, LYONNAISE DES EAUX, GEMALTO, LUDOTIC, MOBILEGOV), (http://continuum.unice.fr), 279 652 \texteuro. Coordinator: University of Nice, Scientific lead in LIG: F. Jouanot and M.-C. Rousset. 
...
\item[Sogrid]  (2013-2017) - ADEME Le réeseau éelectrique de demain
%% à revoir 
...
Customized Advisory Services for Energy-efficient Manufacturing Systems.   Coordinator
...
% C4 : Organisation et vie de lâ'entite 
% 1/2 page
% - Seminaires
% - Vie scientifique de lâ'equipe
...
\item[Devenir:]  Le devenir des doctorants est varieé : X dans l'industrie (Chercheur ou ingéenieur R&D) ;  2 dans le supérieur. 
