...
SLIDE stands for ScaLable Information Discovery and Exploitation. Data today is heterogeneous, ubiquitous, and overwhelming. It is a great challenge to go from data to information, then to knowledge and actionable intelligence. SLIDE's research agenda addresses this challenge and studies problems such as 1) how to efficiently organize and mine information from data; 2) how to better involve humans in data procurement and application evaluation; 3) how to efficiently discover knowledge from data in multiple sources; 4) how to reason over data semantics to enable new access methods. The planned research outcomes are algorithms and infrastructures for large-scale analytics, data linkage and ontology-based data access, crowd data sourcing and crowd-sourced application evaluation.
