...
\item {\it 21th International Joint Conference on Artificial Intelligence (IJCAI-09}: M.-C. Rousset
...
\item[Japon:] 
Parallel data mining is a challenging topic and we reinforced our collaboration  with Japanese groups that  are world leaders in data-mining on structured data.
\begin{description}
...
They include traditional enterprise applications such as mining logs, web applications but also "e-science" applications (in astronomy, biology, earth science, smartgrids, etc.). 
...
Application domains for data mining in structured data include: chemistry (e.g. molecule graphs), bioinformatics (e.g. gene or protein interaction networks), offline or online event logs mining, social networks. 
